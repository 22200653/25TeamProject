...
<div class="wrap">
    <div class="card">
        <h2 style="margin:0;">모집글 추가</h2>

        <form method="post" action="${pageContext.request.contextPath}/admin/recruit/create">
            <div class="field">
                <label>동아리명</label>
            ...
            <div class="field">
                <label>카테고리</label>
                <input name="category" placeholder="예) 문화/예술/공연" required/>
            </div>
